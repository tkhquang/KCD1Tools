...
namespace TPVCamera::Presets
{
    ...
    struct CameraPreset
    {
        ...
        std::string name;
        /**
         * @brief True for the built-ins (DEFAULT/COMBAT/MOUNT/STEALTH/LYING/SITTING/KNEEL);
         *        cannot be removed or renamed.
         */
        bool builtin = false;
        /**
         * @brief States it auto-applies on, comma tokens (e.g. "combat,crouch"); "none" = pin-only,
