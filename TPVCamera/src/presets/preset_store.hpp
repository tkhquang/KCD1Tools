 ...
 *
 *          The built-ins (DEFAULT/COMBAT/MOUNT/STEALTH/LYING/SITTING/KNEEL) are defined by
...
namespace TPVCamera::Presets
{
    ...
    public:
         ...
         *          untouched. The built-ins (DEFAULT/COMBAT/MOUNT/STEALTH/LYING/SITTING/KNEEL) are
         ...
         * @param bind_state Comma-separated tokens (e.g. "combat,crouch"), or "none" to make it pin-only.
         */
