 ...
 *
 * @details Only built when KCD1_TPVCAMERA_DEV_BUILD is ON. The game loads this stub
...
namespace
{
    constexpr const char *k_logic_dll_name = "KCD1_TPVCamera_Logic.dll";
    constexpr const char *k_logic_pdb_name = "KCD1_TPVCamera_Logic.pdb";
    constexpr const char *k_log_prefix = "[KCD1_TPVCamera Loader] ";
